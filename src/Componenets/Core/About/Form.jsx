...
toast.success("Email Recieved by Admin Successfully") 
    ...
    return(
        <div className="w-full bg-[rgb(3,1,29)] py-30">
            <div className="sm:w-3/5 w-10/12 mx-auto border border-gray-500 rounded-md py-2 px-2 ">
               <h1 className="text-white text-2xl font-bold text-center">Get in Touch</h1>
