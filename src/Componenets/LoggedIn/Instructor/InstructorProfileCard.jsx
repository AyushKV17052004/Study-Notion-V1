...
function Profile(){
    ...
    return(
        <div >
            ...
            <div className="lg:w-[800px] mx-auto w-10/12 flex flex-col gap-y-2 mt-10">
                  ...
                  <div className="flex lg:w-[800px] mx-auto w-10/12 lg:flex-row flex-col px-4 py-1 justify-between items-center  bg-gradient-to-tl from-[#030637] via-[#3c0753] to-[#720455] rounded-md border border-gray-700">
                    <div className="flex sm:flex-row flex-col justify-evenly items-center gap-x-2 py-3 text-center">
                        ...
                        <div className="flex flex-col justify-evenly ">
                            ...
                            <p className="text-gray-400 text-xs font-bold">{Data.email}</p>
                        </div>
                    </div>
                    <button onClick={() => {
                    navigate("/Instructor/Home/Dashboard/EditProfile")
                   }}  className="bg-yellow-400 px-2 py-2 rounded-md">Edit</button>
                  </div>
                    ...
                    <div className=" flex flex-col gap-y-2 mt-5 text-center">
                        <div className="flex lg:flex-row flex-col px-5 justify-between  items-center " >
                            <div className="flex flex-col">
                                <h1 className="text-gray-600 text-sm font-bold">First Name</h1>
                                <h1 className="text-white text-sm font-bold">{Data.firstName}</h1>
                            </div>
                            <div className="flex flex-col gap-y-1">
                                <h1 className="text-gray-600 text-sm font-bold">Last Name</h1>
                                <h1 className="text-white text-sm font-bold">{Data.lastName}</h1>
                            </div>
                        </div>
                        <div className="flex lg:flex-row flex-col px-5 justify-between items-center">
                             <div className="flex flex-col  gap-y-1">
                                <h1 className="text-gray-600 text-sm lg:text-left font-bold">Email</h1>
                                <h1 className="text-white text-sm font-bold">{Data.email}</h1>
                            </div>
                            <div className="flex flex-col gap-y-1">
                                <h1 className="text-gray-600 text-sm font-bold">Phone </h1>
                                <h1 className="text-white text-sm font-bold">123456789</h1>
                            </div>
                        </div>
                         <div className="flex flex-row px-5 justify-center lg:justify-between items-center">
                            <div className="flex flex-col gap-y-1">
                             <h1 className="text-gray-600 text-sm font-bold">Account Type </h1>
                                <h1 className="text-white text-sm font-bold">{Data.accountType}</h1>  
                                </div>
                         </div>
                    </div>
                  </div>
