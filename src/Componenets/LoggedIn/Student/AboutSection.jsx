...
import Form from "../../Core/About/Form"
import { useNavigate } from "react-router-dom"
function AboutSection(){
 const navigate = useNavigate()
    return (
    <div className="bg-[rgb(3,1,29)] w-full pt-30 pb-30">
        ...
        <div className="w-10/12 mx-auto grid lg:grid-cols-4 lg:grid-rows-2 sm:grid-cols-2  sm:grid-rows-4 gap-x-2 gap-y-2  mt-20">
           ...
           <button onClick={() => {
                        navigate("/Student/Home/Dashboard/MyProfile")
                    }} className="px-3 py-2 text-lg font-bold text-black bg-yellow-300 rounded-md cursor-pointer hover:scale-90 transition duration-500">Go To Homepage</button>      
           </div>
